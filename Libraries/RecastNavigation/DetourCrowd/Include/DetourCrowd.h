...
enum CrowdAgentState
{
	...
	DT_CROWDAGENT_STATE_STANDING,       ///< The agent is not moving
...
enum UpdateFlags
{
	...
	DT_CROWD_COLLISION_RESOLUTION = 32,
	DT_CROWD_AGENT_PRIORITIES = 64,
};
...
public:
	...
	/// Updates specified agent's state
	///  @param[in]		idx		The agent index. [Limits: 0 <= value < #getAgentCount()]
	///  @param[in]		state	The agent's new state
	void updateAgentState(const int idx, unsigned char state);
